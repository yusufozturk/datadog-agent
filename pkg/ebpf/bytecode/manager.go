...
func NewManager(closedHandler *PerfHandler) *manager.Manager {
	return &manager.Manager{
		...
		Probes: []*manager.Probe{
			{Section: string(TCPSendMsg), Optional: true},
			{Section: string(TCPSendMsgPre410), Optional: true},
			...
			{Section: string(UDPRecvMsg), Optional: true},
			{Section: string(UDPRecvMsgPre410), Optional: true},
			...
			{Section: string(SysBind), SyscallFuncName: "bind", Optional: true},
			{Section: string(SysBindX64), SyscallFuncName: "bind", Optional: true},
			...
			{Section: string(SysSocket), SyscallFuncName: "socket", Optional: true},
			{Section: string(SysSocketX64), SyscallFuncName: "socket", Optional: true},
