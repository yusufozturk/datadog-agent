...
func InitConfig(config Config) {
	...
	config.SetKnown("apm_config.obfuscation.elasticsearch.transform_values")
	config.SetKnown("apm_config.obfuscation.elasticsearch.transformer_type")
	config.SetKnown("apm_config.obfuscation.mongodb.enabled")
	config.SetKnown("apm_config.obfuscation.mongodb.keep_values")
	config.SetKnown("apm_config.obfuscation.mongodb.transform_values")
	config.SetKnown("apm_config.obfuscation.mongodb.transformer_type")
	...
	config.SetKnown("apm_config.obfuscation.sql_exec_plan.transform_values")
	config.SetKnown("apm_config.obfuscation.sql_exec_plan.transformer_type")
	...
	config.SetKnown("apm_config.obfuscation.sql_exec_plan_normalize.transform_values")
	config.SetKnown("apm_config.obfuscation.sql_exec_plan_normalize.transformer_type")
