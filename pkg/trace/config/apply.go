...
type ObfuscationConfig struct {
	...
	// Mongo holds the obfuscation configuration for SQL Exec Plans. This is strictly for safety related obfuscation,
	...
	// Mongo holds the normalization configuration for SQL Exec Plans.
